...
export default function AlertModalDynamic({
  ...
  return (
    ...
    >
      ...
      />
      <div className="z-[60] flex h-auto w-full max-w-sm flex-col items-center justify-center overflow-hidden rounded-lg bg-white bg-opacity-20 font-poppins text-white backdrop-blur-sm">
