...
const CookieConsent = (): JSX.Element => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-slate-700 bg-opacity-70 backdrop-blur-md">
      <div className="fixed bottom-0 left-0 right-0 flex w-full flex-col items-center justify-center gap-y-3 bg-gray-100 px-4 py-8 dark:bg-default-black md:flex-row md:justify-between md:gap-y-0">
