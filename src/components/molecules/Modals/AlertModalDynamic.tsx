...
export default function AlertModalDynamic({
  title,
  message,
  isPending,
  isOpen,
  ...
  return (
    ...
    >
      ...
      />
      <div className="z-[60] flex h-auto w-full max-w-sm flex-col items-center justify-center overflow-hidden rounded-lg bg-white dark:bg-default-black bg-opacity-20 font-poppins text-white backdrop-blur-sm">
