    ...
    <div className="flex w-full flex-col items-center p-3">
      <div className="flex w-full max-w-2xl flex-col items-start gap-y-5">
        ...
        <ul className="list-disc ml-10">
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Magaaazine, accessible from{" "}
              <Link
                className="underline"
                href="https://www.magaaazine.online/"
        ...
        <p>
          ...
          Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the{" "}
          <Link
            className="underline"
        ...
        <h3 className="font-bold">Security of Your Personal Data</h3>
        <p>
