    ...
    <div className="flex w-full flex-col items-center p-3">
      <div className="flex w-full max-w-2xl flex-col items-start gap-y-5">
        ...
        <p>
          ...
          to use Magaaazine if you do not agree to take all of the terms and conditions stated on
          this page.
        </p>
        ...
        <p>
          ...
          agreement with the Magaaazine&apos;s Privacy Policy.{""}
        </p>
        ...
        <p>
          ...
          rights for all material on Magaaazine. All intellectual property rights are reserved. You
          may access this from Magaaazine for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Magaaazine</li>
          <li>Sell, rent or sub-license material from Magaaazine</li>
          <li>Reproduce, duplicate or copy material from Magaaazine</li>
          <li>Redistribute content from Magaaazine</li>
        </ul>
        ...
        <p>
          ...
          information in certain areas of the website. Magaaazine does not filter, edit, publish or
          review Comments prior to their presence on the website. Comments do not reflect the views
          and opinions of Magaaazine,its agents and/or affiliates. Comments reflect the views and
          opinions of the person who post their views and opinions. To the extent permitted by
          applicable laws, Magaaazine shall not be liable for the Comments or for any liability,
          damages or expenses caused and/or suffered as a result of any use of and/or posting of
          and/or appearance of the Comments on this website.
        </p>

        <p>
          Magaaazine reserves the right to monitor all Comments and to remove any Comments which can
        ...
        <p>
          You hereby grant Magaaazine a non-exclusive license to use, reproduce, edit and authorize
        ...
        <p>
          ...
          visibility of the hyperlink compensates the absence of Magaaazine; and (d) the link is in
        ...
        <p>
          ...
          linking to our website, you must inform us by sending an e-mail to Magaaazine. Please
        ...
        <p>
          No use of Magaaazine&apos;s logo or other artwork will be allowed for linking absent a
